export const BAMM_FACTORY_ABI = [
	{
		inputs: [
			{ internalType: "address", name: "_fraxswapFactory", type: "address" },
			{ internalType: "address", name: "_routerMultihop", type: "address" },
			{ internalType: "address", name: "_fraxswapOracle", type: "address" },
			{
				internalType: "address",
				name: "_variableInterestRate",
				type: "address",
			},
	...
	{ inputs: [], name: "BammAlreadyCreated", type: "error" },
	{ inputs: [], name: "Create2Failed", type: "error" },
	{ inputs: [], name: "NotBAMM", type: "error" },
	{
	...
	{ inputs: [], name: "PairNotFromFraxswapFactory", type: "error" },
	{
		anonymous: false,
		inputs: [
			{
	...
	},
	{
		...
		name: "createBamm",
		outputs: [{ internalType: "address", name: "bamm", type: "address" }],
		stateMutability: "nonpayable",
		type: "function",
	},
	{
	...
	{
		inputs: [{ internalType: "address", name: "bamm", type: "address" }],
		name: "isBamm",
	...
	},
	{
		...
		name: "setBAMMVariableInterestRate",
		outputs: [],
		stateMutability: "nonpayable",
		type: "function",
	},
	{
		inputs: [
			{ internalType: "address", name: "bamm", type: "address" },
			{ internalType: "uint256", name: "newMaxOracleDiff", type: "uint256" },
		],
		name: "setBammMaxOracleDiff",
		outputs: [],
		stateMutability: "nonpayable",
		type: "function",
	},
